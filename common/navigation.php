                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarScrollingDropdown">
                                <li><a class="dropdown-item" href="//dsagdullin.alwaysdata.net/ticketPages/newTicket.php">New ticket</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
                                <li><a class="dropdown-item" href="//dsagdullin.alwaysdata.net/ticketPages/showOneTicket.php">Ticket search</a></li>
                                <li><a class="dropdown-item" href="//dsagdullin.alwaysdata.net/ticketPages/showTickets.php">All tickets</a></li>
                            </ul>
                        </li>
                    </ul>
